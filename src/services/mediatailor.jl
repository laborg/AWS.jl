...
"""
    list_programs(channel_name)
    list_programs(channel_name, params::Dict{String,<:Any})
...
- `"nextToken"`: Pagination token from the GET list request. Use the token to fetch the
  next page of results.
"""
list_programs(channelName; aws_config::AbstractAWSConfig=global_aws_config()) = mediatailor("GET", "/channel/$(channelName)/programs"; aws_config=aws_config)
list_programs(channelName, params::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = mediatailor("GET", "/channel/$(channelName)/programs", params; aws_config=aws_config)
